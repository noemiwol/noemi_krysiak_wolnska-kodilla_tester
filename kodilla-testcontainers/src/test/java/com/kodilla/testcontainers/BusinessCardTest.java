...
public class BusinessCardTest {
    ...
    public GenericContainer webServer =
            new GenericContainer(
                    new ImageFromDockerfile()
                            .withFileFromClasspath("/tmp/businessCard.html", "businessCard.html")
                            .withDockerfileFromBuilder(builder ->
                                    builder
                                            .from("httpd:2.4")
                                            .copy("/tmp/businessCard.html", "/usr/local/apache2/htdocs")
                                            .build()))
                    .withNetwork(network)
    ...
    public void customImageTest() throws InterruptedException, IOException {
        ...
        assertEquals("Noemi Krysiak - Wolańska", title);*/
